...
在结构化的摘要中，M2、M3和M4可以通过方法(method)、结果(result)和结论(conclusion)的标题轻松识别。虽然有些摘要中没有“方法”的具体标题，但M2被细分为几个语阶，可以清楚地识别。它们可以被标记为 “实验设计(design)”、“环境设置(setting)”、“参与者(participants)”、“干预(interventions)”、“主要观察指标(main outcome measures)”，等等。
